...
def make_coons(edges):
    from OCCT.GeomFill import GeomFill_BSplineCurves, GeomFill_StretchStyle
    if len(edges) == 4:
...
def make_constrained_surface_from_edges(edges):
    ...
    '''
    from OCCT.GeomPlate import GeomPlate_MakeApprox, GeomPlate_BuildPlateSurface
...
def project_edge_onto_plane(edg, plane):
    ...
    """
    from OCCT.GeomProjLib import geomprojlib_ProjectOnPlane
